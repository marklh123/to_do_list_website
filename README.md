...
<img width="1440" height="753" alt="Screen Shot 2026-05-25 at 10 33 25 PM" src="https://github.com/user-attachments/assets/0de07703-2166-4813-9bd4-c033223f4185" />

## Project Structure
- app.py: backend flask logic
- templates/*;: HTML/CSS files for frontend
- static/*: images for templates

## Limitations
- limited frontend, without layouts, will be akward on certian devices such as phone
